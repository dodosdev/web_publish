...
export default function AppBestSeller() {
    ...
    const [ category, setCategory] = useState(`total`);
        ...
        //의존성 배열(dependency array)은 특정 값들의 변화를 감지하여 Hook의 동작을 제어하는 역할을 한다. 주로 useEffect, useMemo, useCallback 등의 Hook에서 사용된다. 의존성 배열은 React에게 "이 값들이 변경될 때만 이 효과나 계산을 다시 실행해야 해"라고 알려주는 일종의 지시자 역할을 한다. 
