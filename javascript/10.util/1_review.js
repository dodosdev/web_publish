...
// for...of, ...:Spread Operator(전개 구문), Destructring Object(구조분해할당)
// Map: (key,value) - set, get, has, keys, values, entries, clear...
// Set: (value) - add, get(꺼내올때), has, delete, keys, values, clear...

// 1. Spread Operator (스프레드 연산)
